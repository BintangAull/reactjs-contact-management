...
import {contactDetail} from "../../lib/api/ContactApi.jsx";
import {alertError, alertSuccess} from "../../lib/alert.js";
import {useEffectOnce} from "react-use";
import {useState} from "react";
import {createAddresses} from "../../lib/api/AddresessApi.jsx";
...
export default function CreateAddresses() {
   ...
   async function fetchContact(){
    ...
    async function handleSubmitAddresses(e){
        e.preventDefault();
        const response = await createAddresses(token, id,{street, city, province, country, postal_code})
        const responseBody = response.json()
        console.log(responseBody)
        if(response.status === 200){
           ...
           await alertError("address already exist, please try again with another address"+ responseBody.errors)
        }
    }
            ...
            <div className="p-8">
                ...
                <div className="mb-6 pb-6 border-b border-gray-700">
                    <div className="flex items-center">
                        <div
                            className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center mr-4 shadow-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                        ...
                        <div>
                            <label htmlFor="province"
                                   className="block text-gray-300 text-sm font-medium mb-2">Province/State</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                        <div>
                            <label htmlFor="country"
                                   className="block text-gray-300 text-sm font-medium mb-2">Country</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div>
                            <label htmlFor="postal_code" className="block text-gray-300 text-sm font-medium mb-2">Postal
                                Code</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <i className="fas fa-mail-bulk text-gray-500"></i>
                                </div>
                                <input type="text" id="postal_code" name="postal_code" value={postal_code} onChange={(e) => setPostalCode(e.target.value)}
                                       className="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
